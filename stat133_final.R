...
dupli12 = left_join(uc2012, titles, by = 'Title')
dupli13 = left_join(uc2013, titles, by = 'Title')
dupli14 = left_join(uc2014, titles, by = 'Title')

dupli12$Category = dupli12$CTO.Name
dupli12$CTO.Name = NULL

dupli13$Category = dupli13$CTO.Name
dupli13$CTO.Name = NULL

dupli14$Category = dupli14$CTO.Name
dupli14$CTO.Name = NULL

acad_2012 = dupli12[is.na(dupli12$Category) == FALSE, ]
non_acad_2012 = dupli12[is.na(dupli12$Category) == TRUE, ]
acad_2013 = dupli13[is.na(dupli13$Category) == FALSE, ]
non_acad_2013 = dupli13[is.na(dupli13$Category) == TRUE, ]
acad_2014 = dupli14[is.na(dupli14$Category) == FALSE, ]
non_acad_2014 = dupli14[is.na(dupli14$Category) == TRUE, ]
